...
Route::middleware(['auth', 'role:boss,admin'])->group(function () {
    ...
    Route::post('/jobs/{job}/duplicate', [JobController::class, 'duplicate'])
        ->name('jobs.duplicate');
    Route::put('/jobs/{job}/quick-update', [JobController::class, 'quickUpdate'])
        ->name('jobs.quick-update');
});
...
Route::middleware(['auth', 'role:boss'])->group(function () {
    ...
    Route::post('/boss/income/store-extra', [IncomeController::class, 'storeExtraFee'])->name('boss.income.storeExtraFee');
});
...
Route::middleware(['auth', 'role:editor'])->group(function () {
    ...
    Route::post('/editor/verify-crew', [EditorController::class, 'verifyCrew'])
        ->name('editor.verify-crew');
});
