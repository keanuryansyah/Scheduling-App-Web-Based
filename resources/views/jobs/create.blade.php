            ...
            <div class="col-lg-8">
                ...
                <div class="card card-modern">
                    <div class="card-header-custom d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ auth()->user()->role->name == 'admin' ? route('admin.dashboard') : route('boss.dashboard') }}"
                            class="btn btn-primary rounded-pill px-3 py-2 bg-danger">
                            Kembali
                        </a>
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        <label for="notes">Catatan Tambahan. (*WM)</label>
                                    </div>
                                </div>
                            </div>
